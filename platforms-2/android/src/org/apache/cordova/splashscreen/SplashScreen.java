        ...
        cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                Context context = webView.getContext();
				 ...
				 WebView w1=new WebView(context);
				...
				// w1.loadUrl("https://im4.ezgif.com/tmp/ezgif-4-adcbc3e60647.png");
				  w1.loadDataWithBaseURL("file:///android_res/drawable/", "<img src='drawable_port.gif' style='width:100%;height:100%' />", "text/html", "utf-8", null); 
				 
				// w1.loadUrl("file:///android_res/drawable//drawable_port.gif");
...
// w1.getsettings().setloadwithoverviewmode(true);
	// w1.setbackgroundcolor(color.parsecolor("#000000"));
                 ...
                 splashDialog.setContentView(w1);
